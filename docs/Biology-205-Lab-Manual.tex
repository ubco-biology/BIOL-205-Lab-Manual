...
Following on this model, Assignment 3 will be your detailed study design plan. Your TA will be your peer reviewer as they grade your submission. Assignment 4 will be your re-submission of your study design based on feedback from your TA. This will be followed by your final in class presentation of the results of proposed study!

We'll also be moving away from using an R Shiny App to create figures and compute analyses and instead use a few \texttt{R} scripts.

To prepare you for this, we'll start with a short review of materials related to Open Science, \texttt{R}, \& RMarkdown from BIOL 125 and then we'll introduce the \texttt{R} scripts that you'll be using later when you do your final report. After reviewing this material, you will be prompted to complete a quiz in Canvas before the rest of the term's material is made available.
...
\addcontentsline{toc}{subsection}{Why Use \texttt{R} \& RMarkdown?}
...
\addcontentsline{toc}{subsection}{Scientific Writing, Installation of \texttt{R} \& RStudio}
...
For the quiz associated with this lab we'll have you investigate and play around a bit with the scripts we've built for your analyses. And we'll have some sample data that you can use to explore the scripts.

The instructions below primarily relate to building an appropriate project structure for your final report and analyses. It would be good practice at this stage to set up a temporary project space on your computer, using the folder structure detailed below. In fact, when you get the section \href{https://ubco-biology.github.io/BIOL-205-Lab-Manual/practicing-using-the-r-scripts.html}{Practicing Using the \texttt{R} Scripts} later in this lab, you'll be provided with direct links to a sample data set and an appropriate \texttt{R} script to use with that dataset within this directory structure, which will in turn allow you to get the screen shots required for the quiz.
...
Similar to the \texttt{R} scripts, code for all possible statistical tests is included within these templates. \textbf{Only include the code that corresponds with the type of variables in your experiment.} In other words, delete the \texttt{R} chunk that contains code for any statistical test you are \textbf{NOT} using.

Similarly, code for both a boxplot and a stripchart is included within the quantitative-categorical template. If you plan to include a boxplot and not a stripchart, be sure to delete the \texttt{R} chunk that contains the code for the stripchart.
...
\item
  practice using the \texttt{R} script for a categorical explanatory variable and quantitative response variable
\end{itemize}

The next two pages provide you with sample files to do each of these. Refer to the previous sections on working with RMarkdown files and the \texttt{R} scripts if you run into any issues.

The quiz will ask you to upload screenshots and will have questions from the output of the knitting process and the \texttt{R} scripts.
...
\section*{\texorpdfstring{Practicing Using the \texttt{R} Scripts}{Practicing Using the R Scripts}}\label{practicing-using-the-r-scripts}}
\addcontentsline{toc}{section}{Practicing Using the \texttt{R} Scripts}
...
\addcontentsline{toc}{chapter}{Assignment 3: Protocol (first submission)}
...
\hypertarget{assignment-3-detailed-outline}{%
\chapter*{Assignment 3: Detailed Outline}\label{assignment-3-detailed-outline}}
\addcontentsline{toc}{chapter}{Assignment 3: Detailed Outline}
...
\chapter*{Assignment 3: Rubric}\label{assignment-3-rubric}}
\addcontentsline{toc}{chapter}{Assignment 3: Rubric}
...
\addcontentsline{toc}{chapter}{Assignment 4: Protocol (final submission)}
...
\textbf{NEEDS UPDATING AND NEEDS TO INCLUDE DATA DICTIONARY ASPECT}
...
\addcontentsline{toc}{chapter}{Assignment 5: PowerPoint Presentations}
