...
\addcontentsline{toc}{chapter}{Applying Open Science Principles}
...
\tightlist
\item
  Read all of the subsections under the \href{https://ubco-biology.github.io/BIOL-125-Lab-Manual/recommendation-report.html}{Recommendation Report} heading of the BIOL 125 lab manual
\item
  ...
  \tightlist
  \item
    You will use the RMarkdown template provided in BIOL 125 for this research proposal. The template and instructions for how to use the template can be found \href{https://ubco-biology.github.io/BIOL-125-Lab-Manual/assignment-lab-5.html}{here}.
  \end{enumerate}
\end{enumerate}

Since you are completing a research proposal and not writing up the results of a research project, \textbf{remove the results section}.

The discussion section of your report can focus on the \textbf{implications of your proposed project} rather than interpretation of results and client recommendations.
