...
# Assignment 4: Final Registered Report {-}

## Overview {-}

**Due before the end of your lab the week of February 28th (WE SHOULD MAKE THIS DUE DATE LATER IN THE TERM AFTER DATA COLLECITON?)**

<div class = "flag">
You will need to submit 4 files for this assignment:

* Registered report as `.Rmd`
* Registered report as `.pdf`
...
When you submit the final copy of your registered report you will include **ALL** the sections of the assignment template including:
