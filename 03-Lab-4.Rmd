...
You should delete any additional, unused headings, and the pre-populated text under them!

When you submit the final copy of your registered report you will include **ALL** the sections of the assignment template, including the data availability statement, results etc. with a focus on your results and the direct implications and interpretation of those specific results. 
