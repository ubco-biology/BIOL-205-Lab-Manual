...
**Please ensure you submit each summary to the specific submission locations on [Canvas](https://canvas.ubc.ca/courses/113910). Submitting all in one location will result in a mark of zero.**
...
**Here is an example submission**: [primary_source_paper_example_submission.docx](https://osf.io/download/93rpn)
